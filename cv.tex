...
\begin{entrylist}
	...
	{University of Texas at Austin}
	{Founded a club to compete in the International Aerial Robotics Competition with our fully autonomous quadcopter. Uses computer vision and multiple sensors to target and interact with moving ground robots. Placed \nth{4} in our first run}
	...
	% {University of Texas at Austin}
	% {Build robots and make robotics more accessable}
	...
	% {University of Texas at Austin}
	% {Explore the power and energy industry}
	...
	% {University of Texas at Austin}
	% {Learn about the engineering behind theme parks and rollercoasters}
	...
	% {University of Texas at Austin}
	% {Work on Maker related activities}
	...
	% {University of Texas at Austin}
	% {Provide hope and positive vision by mentoring and tutoring children in our community}
	...
	% {University of Texas at Austin}
	% {Recover surplus food from UT Austin dining halls and local food stands and donate it to local food banks}
	...
	% {University of Texas at Austin}
	% {Encourage students to pursue the field of data science and machine learning}
